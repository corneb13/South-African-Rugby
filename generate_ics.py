...
# Route PulseLive API through AllOrigins proxy to bypass GitHub runner IP blocking
TARGET_API = "https://cmsapi.pulselive.com/rugby/match?client=worldrugby&sport=rugbyu&pageSize=100&language=en"
PROXY_URL = f"https://api.allorigins.win/raw?url={urllib.parse.quote(TARGET_API)}"
...
def main():
    print("Fetching Springboks fixtures via proxy relay...")
    events = []
